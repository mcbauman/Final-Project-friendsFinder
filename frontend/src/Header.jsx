   ...
   return(
       <header>
           <nav>
               ...
               <NavLink onClick={()=>{setHide(false); setIsNewMessageCame(false)}}to="Chats"> <span style={{color:isNewMessageCame?"red":""}} className="bigScreen">{trans[lang].Messages}</span><MdOutlineEmail className="smallScreen"/></NavLink>
